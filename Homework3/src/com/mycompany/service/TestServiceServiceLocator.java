...
public class TestServiceServiceLocator extends org.apache.axis.client.Service implements com.mycompany.service.TestServiceService {
    ...
    public com.mycompany.service.TestService getTestServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.mycompany.service.TestServicePortBindingStub _stub = new com.mycompany.service.TestServicePortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.mycompany.service.TestService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.mycompany.service.TestServicePortBindingStub _stub = new com.mycompany.service.TestServicePortBindingStub(new java.net.URL(TestServicePort_address), this);
                _stub.setPortName(getTestServicePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service.mycompany.com/", "TestServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service.mycompany.com/", "TestServicePort"));
        }
