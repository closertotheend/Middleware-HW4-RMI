...
public class TestServiceProxy implements com.mycompany.service.TestService {
  private String _endpoint = null;
  private com.mycompany.service.TestService testService = null;
  ...
  private void _initTestServiceProxy() {
    try {
      testService = (new com.mycompany.service.TestServiceServiceLocator()).getTestServicePort();
      if (testService != null) {
        if (_endpoint != null)
  ...
  public com.mycompany.service.TestService getTestService() {
    if (testService == null)
      _initTestServiceProxy();
    return testService;
  }
